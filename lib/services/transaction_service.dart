...
class TransactionService {
  Future<String> topUp(TopupFormModel data) async {
    try {
      ...
      final res = await http.post(
        Uri.parse('${AppValues.baseUrl}/top_ups'),
        headers: {
          'Authorization': token,
        },
        body: data.toJson(),
  ...
  Future<void> transfer(TransferFormModel data) async {
    try {
      ...
      final res = await http.post(
        Uri.parse('${AppValues.baseUrl}/transfers'),
        headers: {
          'Authorization': token,
        },
        body: data.toJson(),
  ...
  Future<void> dataPlan(DataPlanFormModel data) async {
    try {
      ...
      final res = await http.post(
        Uri.parse('${AppValues.baseUrl}/data_plans'),
        headers: {
          'Authorization': token,
        },
        body: data.toJson(),
  ...
  Future<List<TransactionModel>> getTransaction() async {
    try {
      ...
      final res = await http.get(
        Uri.parse('${AppValues.baseUrl}/transactions'),
        headers: {
          'Authorization': token,
        },
      );
