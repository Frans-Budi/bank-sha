...
class UserService {
  Future<void> updateUser(UserEditFormModel data) async {
    try {
      ...
      final res = await http.put(
        Uri.parse('${AppValues.baseUrl}/users'),
        headers: {
          'Authorization': token,
        },
        body: data.toJson(),
  ...
  Future<List<UserModel>> getRecentUser() async {
    try {
      ...
      final res = await http.get(
        Uri.parse('${AppValues.baseUrl}/transfer_histories'),
        headers: {
          'Authorization': token,
        },
      );
      ...
      throw jsonDecode(res.body)['messagge'];
    } catch (e) {
      rethrow;
    }
  }
  ...
  Future<List<UserModel>> getUserByUsername(String username) async {
    try {
      ...
      final res = await http.get(
        Uri.parse('${AppValues.baseUrl}/users/$username'),
        headers: {
          'Authorization': token,
        },
      );
